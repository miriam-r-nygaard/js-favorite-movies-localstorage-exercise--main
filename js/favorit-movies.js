...
// Henter det HTML-element, vi skal vise favorit-filmene i
const favoritesContainer = document.querySelector("#favorites-container");

/*
  Her gemmes kun film-id'er som favoritter i gemt i localStorage.
...
// Her laves et nyt array med kun de film, hvis id findes i favoriteIds
const favoriteMovies = movies.filter((item) => {
  return favoriteIds.includes(item.id);
});

/*
Her oprettes funktionen displayMovies, som skal vise filmene i browseren.
